...
1. هموارسازی سطح داده (Level)
2. هموارسازی روند (Trend)
...
1. فقط برای **Gauge metrics** مناسب است
2. نیاز به تنظیم دقیق پارامترها دارد
3. برای پیش‌بینی‌های کوتاه‌مدت بهتر عمل می‌کند
4. در نسخه‌های جدید Prometheus ممکن است تغییر کرده باشد
