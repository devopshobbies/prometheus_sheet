...
و یا یک اکسپورتر (exporter) موجود که آن را پوشش دهد پیدا کنید. این شما را با این وضعیت مواجه می‌کند که مجبور شوید خودتان
یک اکسپورتر بنویسید. خبر خوب این است که نوشتن اکسپورترها نسبتاً آسان است.
بخش دشوار، فهمیدن معنای متریک‌هایی است که توسط برنامه‌ها افشا (expose) می‌شوند. واحدها (Units)
اغلب نامشخص هستند و مستندات، اگر اصلاً وجود داشته باشند، می‌توانند مبهم باشند. در این فصل
شما یاد خواهید گرفت که چگونه اکسپورتر بنویسید.
