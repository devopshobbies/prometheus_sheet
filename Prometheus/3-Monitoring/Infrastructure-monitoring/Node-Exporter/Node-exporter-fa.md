...
1. میزان فعالیت دیسک‌های خود را مانیتور کنید
2. مشکلات مربوط به I/O را تشخیص دهید
3. کارایی سیستم ذخیره‌سازی را تحلیل نمایید
